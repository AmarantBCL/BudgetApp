...
class ReportsAdapter : ListAdapter<BudgetUI, ReportsAdapter.ReportsViewHolder>(ReportsDiffItemCallback()) {
    ...
    class ReportsDiffItemCallback : DiffUtil.ItemCallback<BudgetUI>() {
